...
(async () => {
	try {
		...
		const data = await rest.put(
			 ...
			 * For a specific guild, use: Routes.applicationGuildCommands(process.env.CLIENT_ID, process.env.GUILD_ID),
			 * For all guilds, use: Routes.applicationCommands(process.env.CLIENT_ID),
			*/
